...
class Params():
    def __init__(self,args):
        ...
        # self.l = 10. # number of particle diameters for diffusion coeff
        ...
        self.supername = 'im/seg/lin/theta_' + str(-rad2deg(self.theta)) + '/ny_' + str(self.G.ny) + '/ns_' + str(self.G.ns) + '/c_' + str(self.c) + '/D_' + str(self.D) + '/'
