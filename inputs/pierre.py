...
class Params():
    def __init__(self,mode):
        ...
        self.t_f = 100.#100*self.dt # final time (s)
        self.savetime = .1
...
class Solid_Params():
    def __init__(self,G):
        ...
        self.law = 'bingham'
        self.mu_s = 1e0 # shear viscosity
        self.tau_0 = 1e3 # yield stress
        self.mu_0 = 1e6*self.mu_s # much steeper viscosity to mimic very rigid part
        self.mu_v = self.mu_0 # volumetric viscosity
